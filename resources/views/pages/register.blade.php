                    ...
                    <form class="mt-8 space-y-6" action="/register" method="POST">
                        ...
                        <div class="-space-y-px rounded-md shadow-sm flex flex-col gap-5">
                            <div class="flex gap-4 items-center justify-center ">
                                <span class=" font-bold mr-2 text-[#3b82f6] " id="candidat">Candidat</span>
                                <input type="checkbox" name="checkbox" id="check"  class="hidden peer">
                                <!-- <input type="hidden" name="checkbox2" id="check2"> -->
                            ...
                            <div>
                                <label for="email-address" class="sr-only">Full </label>
                                <input id="full-name" name="fullname" type="text"   class="relative block w-full rounded-md border-2 border-black-600 py-1.5 text-gray-900  placeholder:text-gray-400 focus:z-10 focus:ring-1 ring-inset focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2" placeholder="Full ">
                            </div>
                            <div>
