    ...
    <div 
        ...
        <div class="max-w-[600px] w-[75vw] relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div class="sm:flex sm:items-start">
                ...
                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Delete Job Posting</h3>
                <div class="mt-2">
            ...
            <button @click="$emit('closeDeleteModal')" type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
            </div>
        </div>
    </div>
</template>
