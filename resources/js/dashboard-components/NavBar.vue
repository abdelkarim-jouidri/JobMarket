            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex flex-shrink-0 items-center">
                    ...
                    <div class="md:block hidden">
                        <RouterLink to="/">
                            <svg class="" id="kpypeQFYgj" viewBox="0 0 349.99999999999994 158.35472050069157" height="158.35472050069157" width="349.99999999999994" style="FILL: white;width: 175px;height: 200px;position: absolute;top: 65%;left: 50%;z-index: 0;cursor: pointer;transform: translate(-50%, -50%) scale(0.901773);">
                                <defs id="SvgjsDefs1391"></defs>
                                <g id="SvgjsG1392" featurekey="nameFeature-0" transform="matrix(2.247041314619483,0,0,2.247041314619483,11.671179210057844,-33.256211884957466)" fill="#118df0" style="fill: white;">
