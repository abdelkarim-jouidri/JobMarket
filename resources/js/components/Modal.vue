        ...
        <div class="fixed inset-0 bg-gray-600/75 w-screen grid place-items-center">
            <div class="bg-white p-6 w-[50vw] max-h-[450px]  max-w-[600px] rounded-xl">
                ...
                <main>
                    ...
                    <div class="mb-6">
                        <input v-model="jobType" name="job_type" type="text" id="job-type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="job-type" >
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <input v-model="contractType" name="contract_type" type="text" id="contract-type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="contract_type" >
                    </div>
                    <div class="mb-6">
