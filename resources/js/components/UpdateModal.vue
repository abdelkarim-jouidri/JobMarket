<template>
    <div class="fixed inset-0 bg-gray-400/75 grid place-items-center">
        <div id="updateProductModal" tabindex="-1" aria-hidden="true" class=" grid place-items-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
