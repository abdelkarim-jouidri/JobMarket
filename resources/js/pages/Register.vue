...
<section class="flex flex-col md:flex-row h-screen items-center bg-slate-100">
    ...
    <div class="w-full h-100">
        ...
        <button type="submit" class="w-full block bg-gray-800 hover:bg-gray-700 focus:bg-gray-700 text-white font-semibold rounded-lg
        ...
        <p class="mt-8">You Already Have An Account? 
            <RouterLink to="/Login" class="text-blue-950 font-bold"> Login Here</RouterLink>
