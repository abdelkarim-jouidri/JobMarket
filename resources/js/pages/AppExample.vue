<template>
    ...
    <section class="flex flex-col md:flex-row h-screen items-center bg-slate-100">
        ...
        <div class="w-full h-100">
            ...
            <div class="mt-4">
                <input type="password" name="" id="" placeholder="Confirm your Password" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                    focus:bg-white focus:outline-none" required>
            </div>
